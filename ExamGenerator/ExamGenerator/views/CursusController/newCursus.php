<br />
<div>
  <h1 style="display: inline-block" class="mt-5">Nouveau cursus</h1>
...
<form method="post" action="<?= URL_BASE . DS . 'cursus' . DS . 'add' ?>">
  <table class="table">
    <thead>
      <tr>
        <th scope="col">#</th>
    ...
    <tbody>
      <tr>
        ...
        <td><input class="form-control" type="text" name="libelle" value=""></td>
        <td>
