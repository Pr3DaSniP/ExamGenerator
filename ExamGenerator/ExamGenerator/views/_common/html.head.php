<head>
    ...
    <link href="<?php echo VENDOR . DS . "datatables/dataTables.bootstrap4.min.css" ?>" rel="stylesheet">

    <!-- Custom styles for this template-->
    <link href="<?php echo URL_BASE . DS . CSS . DS . '/sb-admin-2.min.css'; ?>" rel="stylesheet">
</head>